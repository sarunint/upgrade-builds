 ...
 * found in the LICENSE file at https://angular.io/license
 */
var tempInjectorRef,VERSION=new _angular_core.Version("7.1.0-beta.2-da59206995");
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(token,downgradedModule){void 0===downgradedModule&&(downgradedModule="");var factory=function($injector){var injectorKey=""+INJECTOR_KEY+downgradedModule,injectableName=isFunction(token)?getTypeName(token):String(token);return validateInjectionKey($injector,downgradedModule,injectorKey,"instantiating injectable '"+injectableName+"'"),$injector.get(injectorKey).get(token)};return factory.$inject=[$INJECTOR],factory},exports.VERSION=VERSION,exports.downgradeModule=function(moduleFactoryOrBootstrapFn){var injector,lazyModuleName=UPGRADE_MODULE_NAME+".lazy"+ ++moduleUid,lazyModuleRefKey=""+LAZY_MODULE_REF+lazyModuleName,lazyInjectorKey=""+INJECTOR_KEY+lazyModuleName,bootstrapFn=isFunction(moduleFactoryOrBootstrapFn)?moduleFactoryOrBootstrapFn:function(extraProviders){return _angular_platformBrowser.platformBrowser(extraProviders).bootstrapModuleFactory(moduleFactoryOrBootstrapFn)};return module$1(lazyModuleName,[]).constant(UPGRADE_APP_TYPE_KEY,3).factory(INJECTOR_KEY,[lazyInjectorKey,identity]).factory(lazyInjectorKey,function(){if(!injector)throw new Error("Trying to get the Angular injector before bootstrapping the corresponding Angular module.");return injector}).factory(LAZY_MODULE_REF,[lazyModuleRefKey,identity]).factory(lazyModuleRefKey,[$INJECTOR,function($injector){setTempInjectorRef($injector);var result={needsNgZone:!0,promise:bootstrapFn(angular1Providers).then(function(ref){return(injector=result.injector=new NgAdapterInjector(ref.injector)).get($INJECTOR),injector})};return result}]).config([$INJECTOR,$PROVIDE,function($injector,$provide){$provide.constant(DOWNGRADED_MODULE_COUNT_KEY,getDowngradedModuleCount($injector)+1)}]),lazyModuleName},exports.UpgradeComponent=UpgradeComponent,exports.UpgradeModule=UpgradeModule,exports.ɵe=angular1Providers,exports.ɵc=compileFactory,exports.ɵa=injectorFactory,exports.ɵd=parseFactory,exports.ɵb=rootScopeFactory,Object.defineProperty(exports,"__esModule",{value:!0})});